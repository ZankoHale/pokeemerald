...
const u8 gText_RedPokeblock[] = _("Red Pokéblock");
const u8 gText_BluePokeblock[] = _("Blue Pokéblock");
const u8 gText_PinkPokeblock[] = _("Pink Pokéblock");
const u8 gText_GreenPokeblock[] = _("Green Pokéblock");
const u8 gText_YellowPokeblock[] = _("Yellow Pokéblock");
const u8 gText_PurplePokeblock[] = _("Purple Pokéblock");
const u8 gText_IndigoPokeblock[] = _("Indigo Pokéblock");
const u8 gText_BrownPokeblock[] = _("Brown Pokéblock");
const u8 gText_LiteBluePokeblock[] = _("Liteblue Pokéblock");
const u8 gText_OlivePokeblock[] = _("Olive Pokéblock");
const u8 gText_GrayPokeblock[] = _("Gray Pokéblock");
const u8 gText_BlackPokeblock[] = _("Black Pokéblock");
const u8 gText_WhitePokeblock[] = _("White Pokéblock");
const u8 gText_GoldPokeblock[] = _("Gold Pokéblock");
...
const u8 gText_PutAway[] = _("putting Away");
...
const u8 gText_GetsAPokeBlockQuestion[] = _(" gets a Pokéblock?");
...
const u8 gText_Dome_fossil[] = _("Dome Fossil");
const u8 gText_Helix_fossil[] = _("Helix Fossil");
const u8 gText_Old_Amber[] = _("Old Amber");
const u8 gText_Skull_fossil[] = _("Skull Fossil");
const u8 gText_Armor_fossil[] = _("Armor Fossil");
