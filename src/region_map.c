...
static const u8 sMapHealLocations[][3] =
{
    ...
    {MAP_GROUP(ROUTE123), MAP_NUM(ROUTE123), HEAL_LOCATION_ROUTE_123},
...
static u8 get_flagnr_blue_points(u16 mapSecId)
{
    switch (mapSecId)
    {
        ...
        case MAPSEC_ROUTE_123:
            return FlagGet(FLAG_LANDMARK_BERRY_MASTERS_HOUSE) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        default:
