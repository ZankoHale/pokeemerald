...
static u8 get_flagnr_blue_points(u16 mapSecId)
{
    switch (mapSecId)
    {
        ...
        case MAPSEC_ROUTE_123:
            return FlagGet(FLAG_LANDMARK_BERRY_MASTERS_HOUSE) ? MAPSECTYPE_BATTLE_FRONTIER : MAPSECTYPE_NONE;
        case MAPSEC_ROUTE_108:
            return FlagGet(FLAG_LANDMARK_ABANDONED_SHIP) ? MAPSECTYPE_BATTLE_FRONTIER : MAPSECTYPE_NONE;
        default:
