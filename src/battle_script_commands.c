...
static void atk07_adjustdamage(void)
{
    ...
    else if (GetBattlerAbility(gBattlerTarget) == ABILITY_STURDY2 && BATTLER_MAX_HP(gBattlerTarget))
    {
        RecordAbilityBattle(gBattlerTarget, ABILITY_STURDY2);
        gSpecialStatuses[gBattlerTarget].sturdied = 1;
    }
    ...
    {
        gMoveResultFlags |= MOVE_RESULT_STURDIED;
        gLastUsedAbility = ABILITY_STURDY2;
    }
    ...
    if (gBattleScripting.moveEffect <= 6) // status change
    {
        ...
        case STATUS1_SLEEP:
            ...
            if (GetBattlerAbility(gEffectBattler) == ABILITY_VITAL_SPIRIT
                ...
                || GetBattlerAbility(gEffectBattler) == ABILITY_NIGHT_KING
...
static void atk76_various(void)
{
    ...
    case VARIOUS_PSYCHO_SHIFT:
        ...
        {
            if (GetBattlerAbility(gBattlerTarget) == ABILITY_INSOMNIA || GetBattlerAbility(gBattlerTarget) == ABILITY_VITAL_SPIRIT || GetBattlerAbility(gBattlerTarget) == ABILITY_NIGHT_KING)
            {
                gBattlerAbility = gBattlerTarget;
                // BattleScriptPush(T1_READ_PTR(gBattlescriptCurrInstr + 3));
                // gBattlescriptCurrInstr = T1_READ_PTR(gBattlescriptCurrInstr + 3);
...
static void atk84_jumpifcantmakeasleep(void)
{
    ...
    else if (ability == ABILITY_INSOMNIA || ability == ABILITY_VITAL_SPIRIT || ability == ABILITY_NIGHT_KING)
    {
        gLastUsedAbility = ability;
        gBattleCommunication[MULTISTRING_CHOOSER] = 2;
        gBattlescriptCurrInstr = jumpPtr;
...
static void atk93_tryKO(void)
{
    ...
    if (gBattleMons[gBattlerTarget].ability == ABILITY_STURDY2)
    {
        gMoveResultFlags |= MOVE_RESULT_MISSED;
        gLastUsedAbility = ABILITY_STURDY2;
        gBattlescriptCurrInstr = BattleScript_SturdyPreventsOHKO;
