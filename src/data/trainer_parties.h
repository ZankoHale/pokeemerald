...
static const struct TrainerMonItemCustomMoves sParty_Sidney[] = {
    ...
    .species = SPECIES_SHARPEDO,
    .heldItem = ITEM_NONE,
    .moves = MOVE_ICE_FANG, MOVE_SWORDS_DANCE, MOVE_CRUNCH, MOVE_PSYCHIC_FANGS
    },
    {
    .iv = 255,
    .lvl = 49,
...
static const struct TrainerMonItemCustomMoves sParty_Phoebe[] = {
    ...
    .species = SPECIES_BANETTE,
    .heldItem = ITEM_NONE,
    .moves = MOVE_SHADOW_CLAW, MOVE_GRUDGE, MOVE_WILL_O_WISP, MOVE_FAINT_ATTACK
    },
    {
    .iv = 250,
    .lvl = 50,
    ...
    .species = SPECIES_DUSCLOPS,
    .heldItem = ITEM_NONE,
    .moves = MOVE_SHADOW_PUNCH, MOVE_TOXIC, MOVE_WILL_O_WISP, MOVE_PROTECT
    },
    {
    .iv = 250,
    .lvl = 49,
    .species = SPECIES_BANETTE,
    .heldItem = ITEM_NONE,
    .moves = MOVE_SHADOW_CLAW, MOVE_PSYCHIC, MOVE_THUNDERBOLT, MOVE_FACADE
    },
    {
    .iv = 255,
    .lvl = 51,
    .species = SPECIES_DUSCLOPS,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = MOVE_SHADOW_PUNCH, MOVE_ICE_BEAM, MOVE_ROCK_SLIDE, MOVE_EARTHQUAKE
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Glacia[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = MOVE_SHADOW_BALL, MOVE_PROTECT, MOVE_ICY_WIND, MOVE_ICE_BEAM
    },
    {
    .iv = 250,
    .lvl = 52,
...
static const struct TrainerMonItemCustomMoves sParty_Glacia2[] = {
    ...
    .species = SPECIES_GLALIE,
    .heldItem = ITEM_NONE,
    .moves = MOVE_CRUNCH, MOVE_EXPLOSION, MOVE_HAIL, MOVE_ICE_BEAM
    },
    {
    .iv = 250,
    .lvl = 67,
    .species = SPECIES_FROSLASS,
    .heldItem = ITEM_NONE,
    .moves = MOVE_SHADOW_BALL, MOVE_WILL_O_WISP, MOVE_HAIL, MOVE_ICE_BEAM
    },
    {
    .iv = 255,
    .lvl = 68,
...
static const struct TrainerMonItemCustomMoves sParty_Drake[] = {
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = MOVE_SIGNAL_BEAM, MOVE_CRUNCH, MOVE_DRAGON_PULSE, MOVE_EARTHQUAKE
    },
    {
    .iv = 250,
    .lvl = 54,
    ...
    .heldItem = ITEM_NONE,
    .moves = MOVE_DISARMING_VOICE, MOVE_DRAGON_PULSE, MOVE_DRAGON_DANCE, MOVE_AERIAL_ACE
    },
    {
    .iv = 250,
    .lvl = 53,
...
static const struct TrainerMonItemCustomMoves sParty_Drake2[] = {
    ...
    .moves = MOVE_OUTRAGE, MOVE_IRON_TAIL, MOVE_PROTECT, MOVE_EXTREME_SPEED
    },
    {
    .iv = 250,
    .lvl = 67,
    .species = SPECIES_ALTARIA,
    .heldItem = ITEM_NONE,
    .moves = MOVE_MOONBLAST, MOVE_DRAGON_PULSE, MOVE_DRAGON_DANCE, MOVE_AERIAL_ACE
    },
    {
    .iv = 250,
    .lvl = 68,
    .species = SPECIES_KINGDRA,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = MOVE_SMOKESCREEN, MOVE_DRAGON_DANCE, MOVE_SURF, MOVE_DRAGON_PULSE
    },
    {
    .iv = 250,
    .lvl = 68,
    .species = SPECIES_FLYGON,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = MOVE_FLAMETHROWER, MOVE_CRUNCH, MOVE_DRAGON_CLAW, MOVE_EARTHQUAKE
    },
    {
    .iv = 250,
    .lvl = 68,
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne1[] = {
    ...
    .species = SPECIES_ARON,
    .heldItem = ITEM_NONE,
    .moves = MOVE_METAL_CLAW, MOVE_ROCK_TOMB, MOVE_HEADBUTT, MOVE_THUNDER_FANG
    },
    {
    .iv = 100,
    .lvl = 12,
    .species = SPECIES_ARON,
    .heldItem = ITEM_NONE,
    .moves = MOVE_METAL_CLAW, MOVE_ROCK_TOMB, MOVE_HEADBUTT, MOVE_FIRE_FANG
    },
    {
    .iv = 100,
    .lvl = 12,
    .species = SPECIES_RHYHORN,
    .heldItem = ITEM_NONE,
    .moves = MOVE_SMACK_DOWN, MOVE_ROCK_TOMB, MOVE_FIRE_FANG, MOVE_THUNDER_FANG
    },
    {
    .iv = 200,
    .lvl = 15,
...
static const struct TrainerMonItemCustomMoves sParty_Brawly1[] = {
    ...
    .species = SPECIES_MACHOP,
    .heldItem = ITEM_NONE,
    .moves = MOVE_BRICK_BREAK, MOVE_LOW_KICK, MOVE_SEISMIC_TOSS, MOVE_BULK_UP
    },
    {
    .iv = 100,
    .lvl = 16,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = MOVE_BUG_BITE, MOVE_AERIAL_ACE, MOVE_BRICK_BREAK, MOVE_BULK_UP
    },
    {
    .iv = 100,
    .lvl = 17,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = MOVE_BUG_BITE, MOVE_VITAL_THROW, MOVE_BRICK_BREAK, MOVE_BULK_UP
    },
    {
    .iv = 100,
    .lvl = 18,
    .species = SPECIES_BRELOOM,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = MOVE_SPORE, MOVE_BULLET_SEED, MOVE_BRICK_BREAK, MOVE_BULK_UP
    },
    {
    .iv = 200,
    .lvl = 19,
...
static const struct TrainerMonItemCustomMoves sParty_Wattson1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = MOVE_SHOCK_WAVE, MOVE_MEGA_DRAIN, MOVE_BUBBLE_BEAM, MOVE_AURORA_BEAM
    },
    {
    .iv = 200,
    .lvl = 20,
    ...
    .heldItem = ITEM_NONE,
    .moves = MOVE_SHOCK_WAVE, MOVE_GRASS_KNOT, MOVE_DOUBLE_TEAM, MOVE_DISARMING_VOICE
    },
    {
    .iv = 200,
    .lvl = 20,
    .species = SPECIES_ELECTRIKE,
    .heldItem = ITEM_NONE,
    .moves = MOVE_SHOCK_WAVE, MOVE_LEER, MOVE_QUICK_ATTACK, MOVE_VOLT_SWITCH
    },
    {
    .iv = 220,
    .lvl = 22,
    .species = SPECIES_MAGNETON,
    .heldItem = ITEM_NONE,
    .moves = MOVE_VOLT_SWITCH, MOVE_SHOCK_WAVE, MOVE_THUNDER_WAVE, MOVE_SONIC_BOOM
    },
    {
    .iv = 250,
    .lvl = 24,
    .species = SPECIES_MANECTRIC,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = MOVE_QUICK_ATTACK, MOVE_THUNDER_WAVE, MOVE_SHOCK_WAVE, MOVE_VOLT_SWITCH
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Flannery1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = MOVE_CONFUSE_RAY, MOVE_WILL_O_WISP, MOVE_HEX, MOVE_SUNNY_DAY
    },
    {
    .iv = 200,
    .lvl = 24,
    ...
    .heldItem = ITEM_WHITE_HERB,
    .moves = MOVE_OVERHEAT, MOVE_BULK_UP, MOVE_BRICK_BREAK, MOVE_NIGHT_SLASH
    },
    {
    .iv = 200,
    .lvl = 24,
...
static const struct TrainerMonItemCustomMoves sParty_Norman1[] = {
    ...
    .species = SPECIES_WIGGLYTUFF,
    .heldItem = ITEM_NONE,
    .moves = MOVE_DISARMING_VOICE, MOVE_FACADE, MOVE_PROTECT, MOVE_HYPER_VOICE
    },
    {
    .iv = 200,
    .lvl = 29,
    ...
    .species = SPECIES_EXPLOUD,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = MOVE_CRUNCH, MOVE_FACADE, MOVE_EXTRASENSORY, MOVE_DISARMING_VOICE
    },
    {
    .iv = 250,
    .lvl = 31,
...
static const struct TrainerMonItemCustomMoves sParty_Winona1[] = {
    ...
    .species = SPECIES_CROBAT,
    .heldItem = ITEM_NONE,
    .moves = MOVE_POISON_FANG, MOVE_PROTECT, MOVE_CONFUSE_RAY, MOVE_AERIAL_ACE
    },
    {
    .iv = 210,
    .lvl = 29,
    .species = SPECIES_SWELLOW,
    .heldItem = ITEM_NONE,
    .moves = MOVE_TAILWIND, MOVE_AERIAL_ACE, MOVE_ROOST, MOVE_BRAVE_BIRD
    },
    {
    .iv = 210,
    .lvl = 29,
    ...
    .moves = MOVE_WATER_PULSE, MOVE_ROOST, MOVE_PROTECT, MOVE_AERIAL_ACE
    },
    {
    .iv = 220,
    .lvl = 31,
    ...
    .species = SPECIES_ALTARIA,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = MOVE_EARTHQUAKE, MOVE_DRAGON_PULSE, MOVE_DISARMING_VOICE, MOVE_AERIAL_ACE
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_TateAndLiza1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = MOVE_PSYCHIC, MOVE_DRAINING_KISS, MOVE_WISH, MOVE_CALM_MIND
    },
    {
    .iv = 250,
    .lvl = 41,
    ...
    .heldItem = ITEM_NONE,
    .moves = MOVE_PSYCHO_CUT, MOVE_WIDE_GUARD, MOVE_NIGHT_SLASH, MOVE_LEAF_BLADE
    },
    {
    .iv = 250,
    .lvl = 42,
...
static const struct TrainerMonItemCustomMoves sParty_Juan1[] = {
    ...
    .moves = MOVE_SIGNAL_BEAM, MOVE_DISCHARGE, MOVE_SOAK, MOVE_WATER_PULSE
    },
    {
    .iv = 200,
    .lvl = 43,
    ...
    .species = SPECIES_KINGDRA,
    .heldItem = ITEM_CHESTO_BERRY,
    .moves = MOVE_WATER_PULSE, MOVE_DRAGON_PULSE, MOVE_ICE_BEAM, MOVE_REST
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Wallace[] = {
    ...
    .species = SPECIES_WAILORD,
    .heldItem = ITEM_NONE,
    .moves = MOVE_RAIN_DANCE, MOVE_WATER_SPOUT, MOVE_DOUBLE_EDGE, MOVE_ICE_BEAM
    },
    {
    .iv = 255,
    .lvl = 55,
    .species = SPECIES_TENTACRUEL,
    .heldItem = ITEM_NONE,
    .moves = MOVE_TOXIC, MOVE_SCALD, MOVE_SLUDGE_BOMB, MOVE_ICE_BEAM
    },
    {
    .iv = 255,
    .lvl = 56,
    .species = SPECIES_LUDICOLO,
    .heldItem = ITEM_NONE,
    .moves = MOVE_ENERGY_BALL, MOVE_SCALD, MOVE_LEECH_SEED, MOVE_DOUBLE_TEAM
    },
    {
    .iv = 255,
    .lvl = 56,
    ...
    .species = SPECIES_GYARADOS,
    .heldItem = ITEM_NONE,
    .moves = MOVE_DRAGON_DANCE, MOVE_EARTHQUAKE, MOVE_GIGA_IMPACT, MOVE_WATERFALL
    },
    {
    .iv = 255,
    .lvl = 58,
...
static const struct TrainerMonItemCustomMoves sParty_Wallace2[] = {
    ...
    .species = SPECIES_GYARADOS,
    .heldItem = ITEM_NONE,
    .moves = MOVE_DRAGON_DANCE, MOVE_EARTHQUAKE, MOVE_BOUNCE, MOVE_WATERFALL
    },
    {
    .iv = 255,
    .lvl = 73,
...
static const struct TrainerMonNoItemCustomMoves sParty_Wally3[] = {
    ...
    .lvl = 48,
    .species = SPECIES_GALLADE,
    .moves = MOVE_BRICK_BREAK, MOVE_BULK_UP, MOVE_PSYCHO_CUT, MOVE_NIGHT_SLASH
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne4[] = {
    ...
    .species = SPECIES_NOSEPASS,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = MOVE_FLASH_CANNON, MOVE_EXPLOSION, MOVE_PROTECT, MOVE_ROCK_SLIDE
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Wattson2[] = {
    ...
    .species = SPECIES_MAGNETON,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = MOVE_VOLT_SWITCH, MOVE_PROTECT, MOVE_THUNDER, MOVE_RAIN_DANCE
    },
    {
    .iv = 255,
    .lvl = 40,
...
static const struct TrainerMonItemCustomMoves sParty_Wattson5[] = {
    ...
    .species = SPECIES_MAGNEZONE,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = MOVE_VOLT_SWITCH, MOVE_PROTECT, MOVE_THUNDERBOLT, MOVE_MAGNET_RISE
    },
    {
    .iv = 255,
    .lvl = 55,
...
static const struct TrainerMonItemCustomMoves sParty_Flannery5[] = {
    ...
    .species = SPECIES_NINETALES,
    .heldItem = ITEM_NONE,
    .moves = MOVE_FLAMETHROWER, MOVE_CONFUSE_RAY, MOVE_SOLAR_BEAM, MOVE_MOONBLAST
    },
    {
    .iv = 255,
    .lvl = 53,
...
static const struct TrainerMonItemCustomMoves sParty_Norman3[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = MOVE_FAKE_OUT, MOVE_POWER_UP_PUNCH, MOVE_ENDURE, MOVE_REVERSAL
    },
    {
    .iv = 255,
    .lvl = 48,
...
static const struct TrainerMonItemCustomMoves sParty_Norman5[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = MOVE_RETURN, MOVE_PROTECT, MOVE_ZEN_HEADBUTT, MOVE_EARTHQUAKE
    },
    {
    .iv = 255,
    .lvl = 58,
    ...
    .species = SPECIES_SLAKING,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = MOVE_GIGA_IMPACT, MOVE_FIRE_PUNCH, MOVE_THUNDER_PUNCH, MOVE_SHADOW_CLAW
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Winona5[] = {
    ...
    .species = SPECIES_PELIPPER,
    .heldItem = ITEM_LEFTOVERS,
    .moves = MOVE_SCALD, MOVE_ROOST, MOVE_PROTECT, MOVE_AERIAL_ACE
    },
    {
    .iv = 255,
    .lvl = 55,
    ...
    .species = SPECIES_ALTARIA,
    .heldItem = ITEM_CHESTO_BERRY,
    .moves = MOVE_BRAVE_BIRD, MOVE_REST, MOVE_DRAGON_DANCE, MOVE_EARTHQUAKE
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Steven[] = {
    ...
    .species = SPECIES_AGGRON,
    .heldItem = ITEM_NONE,
    .moves = MOVE_THUNDER_PUNCH, MOVE_EARTHQUAKE, MOVE_ICE_PUNCH, MOVE_IRON_HEAD
    },
    {
    .iv = 255,
    .lvl = 76,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = MOVE_EARTHQUAKE, MOVE_ZEN_HEADBUTT, MOVE_METEOR_MASH, MOVE_SHADOW_BALL
    }
};
