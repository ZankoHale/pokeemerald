static const struct HealLocation sHealLocations[] =
{
    ...
    {MAP_GROUP(SLATEPORT_CITY), MAP_NUM(SLATEPORT_CITY), 13, 20},
    ...
    {MAP_GROUP(PACIFIDLOG_TOWN), MAP_NUM(PACIFIDLOG_TOWN), 9, 17},
    ...
    {MAP_GROUP(ROUTE123), MAP_NUM(ROUTE123), 22, 7},
    {MAP_GROUP(ROUTE108), MAP_NUM(ROUTE108), 28, 6},
};
