const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_HYPERSPACE_HOLE] = _("H-spaceHole"),
    ...
    [MOVE_DAZZLING_GLEAM] = _("DazzlingGlow"),
    ...
    [MOVE_PRECIPICE_BLADES] = _("PrecipiceBld"),
    [MOVE_DRAGON_ASCENT] = _("DragonAscent"),
    [MOVE_HYPERSPACE_FURY] = _("H-spaceFury"),
    ...
    [MOVE_PSYCHIC_TERRAIN] = _("PsychTerrain"),
    [MOVE_LUNGE] = _("Lunge"),
