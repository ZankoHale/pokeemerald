...
static const u8 gRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    [MAPSEC_DEWFORD_BEACH - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_CAPE_LILYCOVE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_TIDAL_CAVE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE,
};
